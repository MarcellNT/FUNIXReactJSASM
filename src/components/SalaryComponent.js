        ...
        <Card>
            ...
            <CardFooter className="text-center text-white bg-success">
                ...
                <CardTitle>
                    Lương:{" "}
                    {parseInt(
                        basicSalary * staff.salaryScale + overTimeSalary * staff.overTime,
                        10
...
class SalaryList extends Component {
        ...
        switch (sortBy) {
            ...
            case "StaffSalary": {
                staffs.sort((staff1, staff2) => {
                    let staffSalary1 =
                        this.state.basicSalary * staff1.salaryScale +
                        this.state.overTimeSalary * staff1.overTime;
                    let staffSalary2 =
                        this.state.basicSalary * staff2.salaryScale +
                        this.state.overTimeSalary * staff2.overTime;
                    if (staffSalary1 < staffSalary2) {
                        return -1;
                    }
                    if (staffSalary1 > staffSalary2) {
                        return 1;
    ...
    render() {
        ...
        const salaryList = this.props.salaryLoading ? (
            <Loading />
        ) : this.props.salaryErrMess ? (
        ...
        return (
            <div className="container">
                ...
                <div className="row">
                    <div className="col-12">
                        <p>
                            <span className="font-weight-bold">Lương cơ bản: </span>
                            {this.state.basicSalary.toLocaleString("vi-VN")}
                        </p>
                        <p>
                            <span className="font-weight-bold">Lương giờ làm thêm: </span>
                            {this.state.overTimeSalary.toLocaleString("vi-VN")}
                        </p>
                        <hr />
                    </div>
                </div>
