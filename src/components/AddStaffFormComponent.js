...
class AddStaffForm extends Component {
    //Chỉ  submit form khi value of name, doB, startDate là đúng
    handleAddForm(value) {
        if (value.name && value.doB && value.startDate) {
            ...
            const newStaff = {
                name: value.name,
                doB: doB,
                // Nếu chọn department, return departmentId: value.department, nếu không thì giá trị mặc định là Dept01: Sale
